...
\title{Étude de l'influence des dynamiques non-déterministes sur l'évitement de situations dangereuses en apprentissage par renforcement}
...
Grille de 64 cases avec des trous répartis sur l'ensemble de la grille, ne laissant que des passages d'une case de large entre le départ et l'objectif. \\

La figure~\ref{fig:study_cases} illustre les trois configurations.
